...
class _AdminDriversScreenState extends State<AdminDriversScreen>
  ...
  String _status(Map<String, dynamic> d) {
    return (d['verificationStatus'] ?? 'pending').toString();
  }
      ...
      builder: (context, snap) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, i) {
            ...
            final canAccept = (d['canAcceptRides'] ?? false) == true;
  ...
  void _openDetails(String uid, Map<String, dynamic> d) {
    ...
    bools.putIfAbsent(
        'canAcceptRides', () => (d['canAcceptRides'] ?? false) == true);
    bools.putIfAbsent(
                  ...
                  child: BackdropFilter(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        ...requiredDocKeys.map((k) {
                          final url = (docs[k] ?? '').toString().trim();
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color:
                                            ok ? Colors.white : Colors.white54,
                                        fontWeight: FontWeight.w800,
                                      ),
                                    ),
                                  ),
